...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AdminFixtures($b), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\AppFixtures($b), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\ApprenantFixtures($b), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\CMFixtures($b), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\CompetencesFixtures($b), 'groups' => []], 5 => ['fixture' => new \App\DataFixtures\FormateurFixtures($b), 'groups' => []], 6 => ['fixture' => new \App\DataFixtures\GrptagsFixtures(), 'groups' => []], 7 => ['fixture' => new \App\DataFixtures\ProfilFixtures($b), 'groups' => []], 8 => ['fixture' => new \App\DataFixtures\TagsFixtures($b), 'groups' => []], 9 => ['fixture' => new \App\DataFixtures\UserFixtures($b), 'groups' => []]]);
